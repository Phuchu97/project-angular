...
@Component({
  selector: 'app-product-standard',
  templateUrl: './product-standard.component.html',
  styleUrls: ['./product-standard.component.css']
})
export class ProductStandardComponent extends AppComponentBase implements OnInit {
  ...
  public getListProduct() {
    const param = {
      ...
      "category_standard_id": [this.standardId],
