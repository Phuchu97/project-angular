...
export class ShopProductComponent extends AppComponentBase implements OnInit {
  @Input() shopId: number;
  @Input() keywordSearch:string;
  @Output() productCountEvent = new EventEmitter<any>();
  ...
  public getListProduct() {
    ...
    this.productCountEvent.emit(this.temp);
  }

  // public getProductCount()
  // {
  //   this.productCountEvent.emit(this.listProduct.length);
  // }
